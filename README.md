...
``
compile 'biz.kasual:recyclerfragment:1.0.4'
``
...
Eclipse: [recyclerfragment-1.0.4.aar](https://github.com/KasualBusiness/RecyclerFragment/releases/download/1.0.4/recyclerfragment-1.0.4.aar)
